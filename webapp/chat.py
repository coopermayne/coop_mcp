...
_TRAINER_BLURB = (
    ...
    "target weights and reps. If they're planning a FUTURE day ('a leg day for tomorrow', "
    "'something for Saturday'), resolve that date from `now` and pass it as "
    "get_fitness_briefing(for_date=…) so recovery reflects how rested they'll be ON that "
    "day, not today — then build from that briefing (the plan is undated until they finish "
    "it). Program a full session — aim for ~21-26 working sets "
