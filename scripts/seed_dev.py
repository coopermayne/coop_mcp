...
ITEMS = [
    ...
    ("Reading", "Intermezzo", {"author": "Sally Rooney", "status": "Queued"},
     "Robin finished it in a weekend and has been waiting for me to catch up.", "intermezzo"),
...
NOTES = [
    ("Guest room paint", "Robin's leaning toward the greyed-green. Get samples on the wall\n"
