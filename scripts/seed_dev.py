...
d = date(2026, 4, 15)
add(d, "Robin's birthday dinner at Gjelina. Maya and Jordan came; Maya brought a card she made. We split the lamb sausage and three desserts.", ["Robin", "Maya", "Jordan"])

d = date(2026, 4, 17)
add(d, "Coffee with Karl at Equator. He's reading a lot about retirement decumulation and wanted to talk through his approach. Smart guy.", ["Karl"])

# Week of Apr 19
d = date(2026, 4, 19)
add(d, "Hike at Sugarloaf with Robin and Theo. Wildflowers were peaking. Theo's training for a half marathon and set the pace the whole way up.", ["Robin", "Theo"])
...
d = date(2026, 4, 25)
add(d, "Saturday morning with Robin at the guest house. Coffee, both of us reading. She's deep in a Zadie Smith essay collection.", ["Robin"])

# Week of Apr 26
d = date(2026, 4, 26)
add(d, "Brunch with Mom and Ada and Robin at Gjusta. The mom-and-mother-in-law summit. They both love the bakery, so it works as neutral ground.", ["Mom", "Robin"])
...
add(d, "Dinner with Robin. We talked about whether to look at houses in Mar Vista. Both nervous about the timing.", ["Robin"])
...
d = date(2026, 5, 10)
add(d, "Mother's Day. Brunch at Tom and Ada's with Robin and Nina. Both moms in one shot, Tom in good form. Dad showed off his latest model.", ["Tom", "Ada", "Robin", "Nina"])
...
d = date(2026, 5, 20)
add(d, "Beer with Theo — he's in town for a work thing. We caught up on his half-marathon training and his apartment search.", ["Theo"])

d = date(2026, 5, 22)
add(d, "Lunch walk with Jordan around the block. Building HOA stuff. He's running for board.", ["Jordan"])

d = date(2026, 5, 24)
add(d, "Saturday with Robin at the guest house. She made a coffee cake. I worked on the journal app for a few hours.", ["Robin"])

d = date(2026, 5, 25)
add(d, "Sam flew in for the long weekend. Drove him from LAX, dinner at El Coyote. Mom and Dad joined.", ["Sam", "Mom", "Dad"])

d = date(2026, 5, 26)
add(d, "Beach day with Sam and Robin. Long walk to the pier, fish tacos, sunburn.", ["Sam", "Robin"])
...
d = date(2026, 5, 28)
add(d, "Dropped Sam at LAX. Quiet evening with Robin. We watched the new season opener.", ["Sam", "Robin"])
...
# June (current week)
d = date(2026, 6, 1)
add(d, "Back to the guest house to work on the computer for a while next to Robin.", ["Robin"])
add(d, "Back home, I saw Thom in the main house and stopped to say hello while Robin went to the guest house. Talked with Thom and Ada a bit; had a Lillet and a cookie.", ["Thom", "Ada", "Robin"])
...
EXERCISES = [
    ...
    ("Pull Up",           "pull",   ["lats", "biceps", "upper back"],             "vertical pull"),
    ("Barbell Row",       "pull",   ["lats", "upper back", "biceps"],             "horizontal pull"),
    ("Deadlift",          "pull",   ["hamstrings", "glutes", "lower back"],       "hinge"),
    ("Back Squat",        "legs",   ["quads", "glutes"],                          "squat"),
    ("Romanian Deadlift", "legs",   ["hamstrings", "glutes"],                     "hinge"),
    ("Walking Lunge",     "legs",   ["quads", "glutes"],                          "unilateral"),
